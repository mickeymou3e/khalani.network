...
//     function withdraw(address spokeToken, uint32 chainId, address owner, uint256 amount) external;
// }
...
//     event AuthorizationManagerSet(address indexed newManager);
...
//     AuthorizationManager private s_authorizationManager;
...
//     constructor(address _aipEventPublisher) {
...
//     function setAuthorizationManager(address _authorizationManager) external onlyOwner() {
//         require(_authorizationManager != address(0), "Invalid AuthorizationManager address");
//         s_authorizationManager = AuthorizationManager(_authorizationManager);
//         emit AuthorizationManagerSet(_authorizationManager);
//     }

//     function setWithdrawalHandler(address _withdrawalHandler) external onlyOwner {
...
//         if (msg.sender != mToken) {
//             s_authorizationManager.checkAuthorizedMinter(msg.sender);
//         }
...
//     function withdrawMToken(address from, address mToken, uint256 amount) external {
//         if (msg.sender != mToken) {
//             s_authorizationManager.checkAuthorizedLocker(msg.sender);
//         }
//         _validateMToken(mToken);
...
//         WithdrawalHandler(s_withdrawalHandler).withdraw(spokeToken, chainId, from, amount);
//     }
