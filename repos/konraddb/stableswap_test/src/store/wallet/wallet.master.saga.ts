...
import { initializeKhalaBalancesSaga } from '@store/khala/balances/balances.initialize.saga'
...
export function* walletMasterSaga(): Generator {
  yield all([
    ...
    takeLatest(
      walletActions.initializeWalletSuccess.type,
      initializeKhalaBalancesSaga,
    ),
    takeLatest(
