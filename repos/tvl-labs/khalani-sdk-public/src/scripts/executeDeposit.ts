...
const assetReserveAbi = [
  'function deposit(address token, uint256 amount, uint32 destChain, uint256 permitNonce, uint256 deadline, bytes signature) external payable',
]
const tokenAbi = [
...
executeDeposit(Network.ArbitrumSepolia, Network.Khalani)
