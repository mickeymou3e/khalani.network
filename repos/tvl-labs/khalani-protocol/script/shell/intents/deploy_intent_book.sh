...
echo "Deploying Intent Book..."
forge script script/intents/DeployIntentBook.s.sol --broadcast --aws true --sender $DEPLOYER_ADDRESS --slow --legacy --rpc-url $RPC_URL -vvvvv
echo "Deployed Intent Book"
