...
contract AssetReservesTest is Test {
    ...
    function setUp() public {
        ...
        spokeEventProver = new EventProver(address(originMailbox), address(arcadiaEventVerifier), destinationChainId, address(interchainGasPaymaster));
        ...
        assetReserves = new AssetReserves(owner, address(spokeEventPublisher), address(spokeEventHandler), address(permit2));
    ...
    function testDeposit() public {
        ...
        IPermit2.PermitTransferFrom memory permit = utilities.createPermitTransferFrom(
            address(spokeToken),
            1000,
            permitNonce,
            deadline
    ...
    function testUnauthorizedWithdrawReverts() public {
        ...
        string memory expectedRevertMessage = string(
            abi.encodePacked("AccessControl: account ", accountStr, " is missing role ", roleStr)
        );
