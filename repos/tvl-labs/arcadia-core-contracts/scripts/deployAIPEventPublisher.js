...
async function main() {
  ...
  const eventProversConfig = {
    holesky: {
      defaultProver: network.config.eventProver.avalanche,
      eventProvers: [
        {
          chainId: 1098411886,
    ...
    khalani: {
      defaultProver: network.config.eventProver.ethereum,
      eventProvers: [
        {
          chainId: 11155111,
          proverAddress: network.config.eventProver.ethereum,
        },
        { chainId: 43113, proverAddress: network.config.eventProver.avalanche },
      ],
    },
    ethereum: {
      ...
      eventProvers: [
        {
          chainId: 43113,
          proverAddress: network.config.eventProver.avalanche,
        },
        {
          chainId: 1098411886,
          proverAddress: network.config.eventProver.khalani,
