...
const EXTENDED_CHAIN_CONFIG = {
  ...chainConfig,
  axon: {
    chainId: 10012,
    urls: {
      apiURL: 'https://khalani-axon-explorer-staging.digipnyx.org/api',
      browserURL: 'https://khalani-axon-explorer-staging.digipnyx.org',
    },
  },
  'godwoken-testnet': {
    chainId: 71401,
    urls: {
      apiURL: 'https://gw-explorer.nervosdao.community/api',
      browserURL: 'https://gw-explorer.nervosdao.community',
    },
  },
  'godwoken-mainnet': {
    chainId: 71402,
