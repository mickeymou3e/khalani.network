...
# The Khalani Chain instruction

This repository is part of the Balancer infrastructure required for Khalani project. 

[Click to see the deployment instruction.](./khalani-deployment.md)
