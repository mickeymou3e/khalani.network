...
contract HubConnectProverToVerifier is BaseHubScript {
    function run() public override {
        ...
        igp = getContractAddressFromBroadcast("MockInterchainGasPaymaster", "HubDeployCoreProtocol.s.sol", chainId);
        console.log("igp:", igp);
        ...
        console.log("eventHandler transferred to contractsManager");
