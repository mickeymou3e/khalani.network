...
contract MTokenAdapterTest is Test {
    ...
    function setUp() public {
        ...
        localCrossChainAdapter = new MTokenCrossChainAdapter(address(0x2), address(0x3), address(0x4), address(0x5));
    ...
    function testGetWithdrawEventTypeLocal() public {
        ...
        bytes32 expectedWithdrawType = keccak256(abi.encode(address(localCrossChainAdapter), withdrawalEventTypeHash));
