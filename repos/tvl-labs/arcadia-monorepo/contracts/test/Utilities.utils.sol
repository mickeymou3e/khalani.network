...
contract Utilities is Test {
    ...
    // This is actually spend an input intent by creating a new receipt
    ...
    function createSimpleIntent(
        ...
        // Hash the intent
        bytes32 intentHash = IntentLib.hashIntentWithEip712(intent, verifyingContract);
    ...
    function _randomUint256() public view returns (uint256) {
