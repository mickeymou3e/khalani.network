...
export const AXON_CROSS_CHAIN_ROUTER_ABI: ContractInterface = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: 'LogWithdrawMultiTokenAndCall',
    type: 'event',
  },
  {
    inputs: [
    ...
    name: 'withdrawMultiTokenAndCall',
    outputs: [],
...
export const MSG_HANDLER_FACET_ABI: ContractInterface = [
  {
    inputs: [
      {
        internalType: 'address',
  ...
  },
  {
    ...
    name: 'addChainTokenForMirrorToken',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
