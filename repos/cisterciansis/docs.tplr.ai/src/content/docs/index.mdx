...
The `Miner` class in [neurons/miner.py](https://github.com/tplr-ai/templar/blob/main/neurons/miner.py) implements this functionality, with its main loop in the asynchronous `run()` method.
...
The `Validator` class in [neurons/validator.py](https://github.com/tplr-ai/templar/blob/main/neurons/validator.py) implements this functionality, with evaluation logic in `evaluate_model_on_batches()` and weight setting in `update_weights()`.
...
Templar uses a configuration system with parameters defined in [hparams.json](https://github.com/tplr-ai/templar/blob/bb2fc2a9/hparams.json). Key parameters include:
...
- For detailed miner functionality, see [Miners](/reference/miners)
- For validator operations, see [Validators](/reference/validators)
- For aggregation server, see [Aggregation Server](/reference/aggregation-server)
- For communication system details, see [Communication System](/reference/communication-system)
- For system architecture, see [System Architecture](/reference/system-architecture)