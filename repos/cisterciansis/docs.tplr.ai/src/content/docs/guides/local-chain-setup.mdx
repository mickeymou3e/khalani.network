...
<CollapsibleAside title="Relevant Source Files">
  <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/README.md" text="scripts/local_chain/README.md" />
  <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/docker-compose.yaml" text="scripts/local_chain/docker-compose.yaml" />
  <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup.sh" text="scripts/local_chain/setup.sh" />
  <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup_subnet.py" text="scripts/local_chain/setup_subnet.py" />
</CollapsibleAside>
...
For deploying with Docker in production environments, see [Docker Deployment](/guides/docker-deployment). For Ansible-based deployment, see [Ansible Deployment](/guides/ansible-deployment).
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/docker-compose.yaml" text="scripts/local_chain/docker-compose.yaml" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup.sh" text="scripts/local_chain/setup.sh" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup.sh" text="scripts/local_chain/setup.sh" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup_subnet.py" text="scripts/local_chain/setup_subnet.py" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup.sh#L4-L47" text="scripts/local_chain/setup.sh4-47" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup_subnet.py#L11-L138" text="scripts/local_chain/setup_subnet.py11-138" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup_subnet.py#L13-L40" text="scripts/local_chain/setup_subnet.py13-40" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/README.md#L69-L77" text="scripts/local_chain/README.md69-77" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/README.md#L27-L39" text="scripts/local_chain/README.md27-39" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/docker-compose.yaml#L1-L52" text="scripts/local_chain/docker-compose.yaml1-52" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup_subnet.py#L45-L127" text="scripts/local_chain/setup_subnet.py45-127" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/README.md#L96-L134" text="scripts/local_chain/README.md96-134" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/README.md#L88-L95" text="scripts/local_chain/README.md88-95" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/local_chain/setup.sh#L8-L9" text="scripts/local_chain/setup.sh8-9" />