...
This document provides comprehensive guidance for setting up and using the development environment for the Templar decentralized training framework. It covers environment setup, development tools, and common workflows for contributors. For information about testing specifically, see [Testing](/guides/testing). For deployment options, see [Deployment](/guides/deployment).
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L22-L23" text="justfile22-23" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.gitignore#L1-L2" text=".gitignore1-2" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L5-L33" text="justfile5-33" />

### UV Package Manager

Templar uses UV for Python package management instead of pip. UV provides faster dependency resolution and installation.

Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L22-L23" text="justfile22-23" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.gitignore#L29-L34" text=".gitignore29-34" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L5-L33" text="justfile5-33" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/start.sh#L1-L16" text="scripts/start.sh1-16" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L5-L11" text="justfile5-11" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L25-L32" text="justfile25-32" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/justfile#L28-L29" text="justfile28-29" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/start.sh#L5-L6" text="scripts/start.sh5-6" />
