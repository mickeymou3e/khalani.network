...
The Metrics Logging system in Templar provides comprehensive monitoring capabilities for tracking training progress, system performance, and resource utilization across the distributed training framework. It enables real-time collection of metrics from miners, validators, and other components, with data stored in InfluxDB for subsequent analysis and visualization. For information about visualizing this data through dashboards, see [Dashboards](/reference/dashboards). For experiment tracking with Weights & Biases, see [Experiment Tracking](/reference/experiment-tracking).
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L82-L360" text="src/tplr/metrics.py82-360" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L182-L255" text="src/tplr/metrics.py182-255" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L88-L105" text="src/tplr/metrics.py88-105" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L44-L53" text="src/tplr/metrics.py44-53" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L154-L180" text="src/tplr/metrics.py154-180" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L227-L255" text="src/tplr/metrics.py227-255" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L182-L201" text="src/tplr/metrics.py182-201" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L62-L79" text="src/tplr/metrics.py62-79" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/metrics.py#L130-L136" text="src/tplr/metrics.py130-136" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L316-L331" text="tests/test_metrics_logger.py316-331" />
...
Sources: <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L1-L342" text="tests/test_metrics_logger.py1-342" />, <SourceLink href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/telemetry/simulator/testing_metrics.py#L1-L52" text="telemetry/simulator/testing_metrics.py1-52" />