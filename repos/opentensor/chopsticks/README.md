...
Fork Subtensort: `npx @acala-network/chopsticks@latest --endpoint=wss://entrypoint-finney.opentensor.ai`
...
npx @acala-network/chopsticks@latest --config=configs/bittensor.yml
```
...
- Replay latest block
  - `npx @acala-network/chopsticks@latest run-block --endpoint=wss://entrypoint-finney.opentensor.ai`
...
```
npx @acala-network/chopsticks@latest dry-run --config=configs/bittensor.yml --html --open --extrinsic=0xaad08b62b5db37f27e8866d4c72c6579ce8099ae21dd335224687060ba4c8315
```

- Dry run call, make sure `mock-signature-host: true` to fake caller's signature:
```
npx @acala-network/chopsticks@latest dry-run --config=configs/bittensor.yml --html --open --extrinsic=0xaad08b62b5db37f27e8866d4c72c6579ce8099ae21dd335224687060ba4c8315 --address=5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY --at=<block_hash_optional>
```

- Dry run a preimage:
 ```
npx @acala-network/chopsticks@latest dry-run --endpoint=wss://entrypoint-finney.opentensor.ai --preimage=<preimage> --open
 ```
...
- Run a test node
  - `npx @acala-network/chopsticks@latest --endpoint=wss://entrypoint-finney.opentensor.ai`
