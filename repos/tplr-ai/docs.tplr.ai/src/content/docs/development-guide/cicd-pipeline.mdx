...
This document details the Continuous Integration and Continuous Deployment (CI/CD) pipeline implemented for the Templar project. It focuses on the automated workflows that run when code changes are pushed, ensuring code quality, test coverage, and consistent formatting. For information about the development environment setup, see [Development Environment](/development-guide/development-environment#10.1), and for testing strategies, see [Testing](/development-guide/testing#10.2).
...
Sources: <SourceLink text=".github/workflows/ci.yml:3-8" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L3-L8" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:9-122" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L9-L122" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:10-17" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L10-L17" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:19-44" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L19-L44" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:46-122" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L46-L122" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:53-70" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L53-L70" />, <SourceLink text=".github/workflows/ci.yml:78-100" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L78-L100" />
...
Sources: <SourceLink text="codecov.yml:1-10" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/codecov.yml#L1-L10" />, <SourceLink text=".github/workflows/ci.yml:112-121" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L112-L121" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:30-35" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L30-L35" />, <SourceLink text=".github/workflows/ci.yml:102-110" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L102-L110" />
...
Sources: <SourceLink text="codecov.yml:12-15" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/codecov.yml#L12-L15" />, <SourceLink text=".github/workflows/ci.yml:116-121" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L116-L121" />
...
Sources: <SourceLink text=".github/workflows/ci.yml:1-122" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/.github/workflows/ci.yml#L1-L122" />, <SourceLink text="codecov.yml:1-15" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/codecov.yml#L1-L15" />