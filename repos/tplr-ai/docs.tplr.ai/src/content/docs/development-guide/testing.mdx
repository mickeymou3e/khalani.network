...
This page documents the testing infrastructure and practices for the Templar codebase. It covers the test organization, key test fixtures, testing of core components, and guidelines for running tests and creating new tests. For information about the CI/CD pipeline, see [CI/CD Pipeline](/development-guide/cicd-pipeline#10.3).
...
Sources: <SourceLink text="tests/conftest.py" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/conftest.py" />, <SourceLink text="tests/test_metrics_logger.py" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py" />, <SourceLink text="tests/test_evaluator.py" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_evaluator.py" />, <SourceLink text="tests/test_checkpoints.py" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_checkpoints.py" />, <SourceLink text="tests/test_prepare_gradient_dict.py" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_prepare_gradient_dict.py" />
...
Sources: <SourceLink text="tests/conftest.py:60-197" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/conftest.py#L60-L197" />
...
Sources: <SourceLink text="tests/test_metrics_logger.py:58-341" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L58-L341" />
...
Sources: <SourceLink text="tests/test_evaluator.py:21-143" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_evaluator.py#L21-L143" />
...
Sources: <SourceLink text="tests/test_checkpoints.py:236-774" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_checkpoints.py#L236-L774" />
...
Sources: <SourceLink text="tests/test_prepare_gradient_dict.py:80-516" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_prepare_gradient_dict.py#L80-L516" />
...
Sources: <SourceLink text="tests/conftest.py:60-198" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/conftest.py#L60-L198" />
...
Sources: <SourceLink text="tests/conftest.py:1-6" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/conftest.py#L1-L6" />, <SourceLink text="tests/test_evaluator.py:59-143" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_evaluator.py#L59-L143" />, <SourceLink text="tests/test_checkpoints.py:279-593" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_checkpoints.py#L279-L593" />
...
Sources: <SourceLink text="tests/test_metrics_logger.py:40-55" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L40-L55" />, <SourceLink text="tests/test_metrics_logger.py:84-114" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L84-L114" />, <SourceLink text="tests/test_metrics_logger.py:60-82" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/tests/test_metrics_logger.py#L60-L82" />
