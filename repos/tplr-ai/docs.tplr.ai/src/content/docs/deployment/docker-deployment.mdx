...
For information about deploying with Ansible, see [Ansible Deployment](/deployment/ansible-deployment#8.2). For setting up a local Subtensor chain for development, see [Local Chain Setup](/deployment/local-chain-setup#8.3).
...
Sources: <SourceLink text="docker/Dockerfile" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docker/Dockerfile" />, <SourceLink text="scripts/entrypoint.sh" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/scripts/entrypoint.sh" />
...
Sources: <SourceLink text="docker/compose.yml:36-42" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docker/compose.yml#L36-L42" />, <SourceLink text="docker/docker-compose-test.yml:31-37" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docker/docker-compose-test.yml#L31-L37" />
...
Sources: <SourceLink text="docker/compose.yml:46-57" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docker/compose.yml#L46-L57" />
...
Sources: <SourceLink text="docker/docker-compose-test.yml" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docker/docker-compose-test.yml" />