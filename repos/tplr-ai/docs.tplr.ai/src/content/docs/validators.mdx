...
For information about the miners that validators evaluate, see [Miners](/miners#2). For details on how validators set weights on the blockchain, see [Weight Setting](/validators/weight-setting#3.1).
...
Sources: <SourceLink text="neurons/validator.py:85-267" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L85-L267" />, <SourceLink text="neurons/validator.py:355-480" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L355-L480" />
...
Sources: <SourceLink text="neurons/validator.py:126-267" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L126-L267" />
...
Sources: <SourceLink text="neurons/validator.py:516-635" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L516-L635" />. <SourceLink text="neurons/validator.py:695-787" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L695-L787" />, <SourceLink text="neurons/validator.py:374-445" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L374-L445" />
...
Sources: <SourceLink text="neurons/validator.py:489-514" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L489-L514" />, <SourceLink text="neurons/validator.py:374-445" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L374-L445" />
...
Sources: <SourceLink text="neurons/validator.py:374-445" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L374-L445" />, <SourceLink text="neurons/validator.py:356-380" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L356-L380" />
...
Sources: <SourceLink text="neurons/validator.py:302-315" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L302-L315" />, <SourceLink text="neurons/validator.py:706-733" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L706-L733" />
...
Sources: <SourceLink text="neurons/validator.py:576-623" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L576-L623" />
...
Sources: <SourceLink text="neurons/validator.py:642-704" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L642-L704" />
...
Sources: <SourceLink text="neurons/validator.py:831-860" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L831-L860" />, <SourceLink text="src/tplr/comms.py:64-682" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/src/tplr/comms.py#L64-L682" />
...
Sources: <SourceLink text="docs/validator.md:306-313" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docs/validator.md#L306-L313" />
...
Sources: <SourceLink text="neurons/validator.py:86-124" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/neurons/validator.py#L86-L124" />, <SourceLink text="docs/validator.md:116-150" href="https://github.com/tplr-ai/templar/blob/bb2fc2a9/docs/validator.md#L116-L150" />

## Related Systems

The validator integrates with several other Templar systems:

1. **Miners**: The nodes that validators evaluate ([Miners](/miners#2))
2. **Aggregation Server**: Provides synchronized model state ([Aggregation Server](/aggregation-server#4))
3. **Bittensor Network**: Blockchain for weight setting ([Chain Integration](/communication-system/chain-integration#6.2))
4. **R2 Storage**: Communication medium for gradient exchange ([R2 Storage](/data-management/r2-storage#7.1))
5. **Monitoring**: Performance tracking via WandB and InfluxDB ([Monitoring and Telemetry](/monitoring-and-telemetry#9))
