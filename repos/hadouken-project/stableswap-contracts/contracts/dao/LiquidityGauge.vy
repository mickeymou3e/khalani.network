...
MINTER: constant(address) = 0x04705D2900679AFC106c266A6F45fDD5D33f44A8
HDK: constant(address) = 0x0EC67E37Cb6a483db738d3ee2B4cE0b97351c614
VOTING_ESCROW: constant(address) = 0xb1d2251D810F14a87588d79eBAC33c964F6Eac1F
GAUGE_CONTROLLER: constant(address) = 0x5DdB7833BA5BD85CFa94A4deb61FD5434a4948e7
...
def __init__(_lp_token: address, _admin: address):
    ...
    self.name = concat("Hadouken.finance ", symbol, " Gauge Deposit")
    self.symbol = concat(symbol, "-gauge")

    self.period_timestamp[0] = block.timestamp
    self.inflation_rate = HDK20(HDK).rate()
    self.future_epoch_time = HDK20(HDK).future_epoch_time_write()
...
def _update_liquidity_limit(addr: address, l: uint256, L: uint256):
    """
    @notice Calculate limits which depend on the amount of HDK token per-user.
            Effectively it calculates working balances to apply amplification
            of HDK production by HDK
...
def set_killed(_is_killed: bool):
    ...
    @dev When killed, the gauge always yields a rate of 0 and so cannot mint HDK
