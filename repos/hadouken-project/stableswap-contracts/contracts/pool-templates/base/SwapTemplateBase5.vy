...
PRECISION_MUL: constant(uint256[N_COINS]) = [1, 1000000000000, 1000000000000, 1, 1000000000000]
RATES: constant(uint256[N_COINS]) = [1000000000000000000, 1000000000000000000000000000000, 1000000000000000000000000000000, 1000000000000000000, 1000000000000000000000000000000]
