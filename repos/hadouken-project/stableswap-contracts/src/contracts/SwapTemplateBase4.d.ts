...
interface SwapTemplateBase4Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export class SwapTemplateBase4 extends Contract {
  ...
  interface: SwapTemplateBase4Interface;
  ...
  functions: {
    ...
    remove_liquidity(
      ...
      _min_amounts: [BigNumberish, BigNumberish, BigNumberish, BigNumberish],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
