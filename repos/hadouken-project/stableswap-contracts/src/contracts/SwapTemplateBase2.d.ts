...
interface SwapTemplateBase2Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export class SwapTemplateBase2 extends Contract {
  ...
  interface: SwapTemplateBase2Interface;
