...
interface SwapTemplateBase5Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
    ...
    "remove_liquidity(uint256,uint256[5])": FunctionFragment;
    "remove_liquidity_imbalance(uint256[5],uint256)": FunctionFragment;
  ...
  events: {
    ...
    "AddLiquidity(address,uint256[5],uint256[5],uint256,uint256)": EventFragment;
    "RemoveLiquidity(address,uint256[5],uint256[5],uint256)": EventFragment;
    "RemoveLiquidityOne(address,uint256,uint256,uint256)": EventFragment;
    "RemoveLiquidityImbalance(address,uint256[5],uint256[5],uint256,uint256)": EventFragment;
...
export class SwapTemplateBase5 extends Contract {
  ...
  interface: SwapTemplateBase5Interface;
  ...
  filters: {
    ...
    AddLiquidity(
      ...
      {
        provider: string;
        token_amounts: [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber];
        fees: [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber];
        invariant: BigNumber;
