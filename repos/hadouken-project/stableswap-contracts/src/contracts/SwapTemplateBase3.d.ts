...
interface SwapTemplateBase3Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export class SwapTemplateBase3 extends Contract {
  ...
  interface: SwapTemplateBase3Interface;
  ...
  functions: {
    ...
    remove_liquidity(
      ...
      _min_amounts: [BigNumberish, BigNumberish, BigNumberish],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
