...
export class Registry extends Contract {
  ...
  functions: {
    ...
    "get_coin_swap_complement(address,uint256)"(
      _coin: string,
      _index: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string]>;
    ...
    "add_pool(address,uint256,address,bytes32,uint256,uint256,bool,bool,string)"(
      _pool: string,
      _n_coins: BigNumberish,
      _lp_token: string,
      _rate_info: BytesLike,
    ...
    "add_pool_without_underlying(address,uint256,address,bytes32,uint256,uint256,bool,bool,string)"(
      _pool: string,
      _n_coins: BigNumberish,
      _lp_token: string,
      _rate_info: BytesLike,
    ...
    "set_liquidity_gauges(address,address[10])"(
      _pool: string,
      _liquidity_gauges: [
        string,
        string,
    ...
    "set_pool_asset_type(address,uint256)"(
      _pool: string,
      _asset_type: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
