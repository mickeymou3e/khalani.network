...
interface LiquidityGaugeRewardInterface extends ethers.utils.Interface {
  functions: {
    ...
    "toggle_external_rewards_claim(bool)": FunctionFragment;
    ...
    "is_claiming_rewards()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "toggle_external_rewards_claim",
    values: [boolean]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "is_claiming_rewards",
    values?: undefined
  ): string;
...
export class LiquidityGaugeReward extends Contract {
  ...
  functions: {
    ...
    "toggle_external_rewards_claim(bool)"(
      val: boolean,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    is_claiming_rewards(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    is_claiming_rewards(overrides?: CallOverrides): Promise<BigNumber>;
