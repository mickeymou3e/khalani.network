...
import type { HadoukenToken } from "../HadoukenToken";

export class HadoukenToken__factory extends ContractFactory {
  ...
  ): Promise<HadoukenToken> {
    return super.deploy(
      _name,
      _symbol,
      overrides || {}
    ) as Promise<HadoukenToken>;
  }
  ...
  attach(address: string): HadoukenToken {
    return super.attach(address) as HadoukenToken;
  }
  connect(signer: Signer): HadoukenToken__factory {
    return super.connect(signer) as HadoukenToken__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HadoukenToken {
    return new Contract(address, _abi, signerOrProvider) as HadoukenToken;
  }
}
