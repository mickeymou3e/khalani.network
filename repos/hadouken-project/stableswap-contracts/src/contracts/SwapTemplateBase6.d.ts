...
interface SwapTemplateBase6Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
    ...
    "remove_liquidity(uint256,uint256[6])": FunctionFragment;
    "remove_liquidity_imbalance(uint256[6],uint256)": FunctionFragment;
  ...
  events: {
    ...
    "AddLiquidity(address,uint256[6],uint256[6],uint256,uint256)": EventFragment;
    "RemoveLiquidity(address,uint256[6],uint256[6],uint256)": EventFragment;
    "RemoveLiquidityOne(address,uint256,uint256,uint256)": EventFragment;
    "RemoveLiquidityImbalance(address,uint256[6],uint256[6],uint256,uint256)": EventFragment;
...
export class SwapTemplateBase6 extends Contract {
  ...
  interface: SwapTemplateBase6Interface;
