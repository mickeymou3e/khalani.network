...
interface SwapTemplateBase7Interface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
    "A_precise()": FunctionFragment;
    "get_virtual_price()": FunctionFragment;
    "calc_token_amount(uint256[7],bool)": FunctionFragment;
    "add_liquidity(uint256[7],uint256)": FunctionFragment;
    "get_dy(int128,int128,uint256)": FunctionFragment;
    "exchange(int128,int128,uint256,uint256)": FunctionFragment;
    "remove_liquidity(uint256,uint256[7])": FunctionFragment;
    "remove_liquidity_imbalance(uint256[7],uint256)": FunctionFragment;
  ...
  events: {
    ...
    "AddLiquidity(address,uint256[7],uint256[7],uint256,uint256)": EventFragment;
    "RemoveLiquidity(address,uint256[7],uint256[7],uint256)": EventFragment;
    "RemoveLiquidityOne(address,uint256,uint256,uint256)": EventFragment;
    "RemoveLiquidityImbalance(address,uint256[7],uint256[7],uint256,uint256)": EventFragment;
...
export class SwapTemplateBase7 extends Contract {
  ...
  interface: SwapTemplateBase7Interface;
  ...
  functions: {
    ...
    "calc_token_amount(uint256[7],bool)"(
      _amounts: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    "add_liquidity(uint256[7],uint256)"(
      _amounts: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    "remove_liquidity(uint256,uint256[7])"(
      _amount: BigNumberish,
      _min_amounts: [
        BigNumberish,
        BigNumberish,
