...
interface SwapsInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "factory_registry",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Swaps extends Contract {
  ...
  functions: {
    ...
    "get_best_rate(address,address,uint256,address[8])"(
      _from: string,
      _to: string,
      _amount: BigNumberish,
      _exclude_pools: [
    ...
    "set_default_calculator(address)"(
      _calculator: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
