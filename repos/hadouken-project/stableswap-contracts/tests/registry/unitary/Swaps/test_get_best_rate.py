import pytest
from brownie import Factory, ETH_ADDRESS, ZERO_ADDRESS
...
# CHANGE: in curve.fi Factory contract is located in separate repo
# Factory contract currently is in teststing contracts, should be moved
@pytest.fixture(scope="module")
def factory(pm, alice):
    yield Factory.deploy({"from": alice})
