import pytest
from brownie import ERC20Mock, ERC20NoReturn, ERC20ReturnFalse, cERC20, yERC20
...
@pytest.fixture(scope="module")
def lp_token(alice):
    return ERC20Mock.deploy("MetaTest Token", "MTST", 18, {"from": alice})
...
def _underlying_coins(_underlying_decimals, alice):
    deployers = [ERC20Mock, ERC20NoReturn, ERC20ReturnFalse]
    coins = []
