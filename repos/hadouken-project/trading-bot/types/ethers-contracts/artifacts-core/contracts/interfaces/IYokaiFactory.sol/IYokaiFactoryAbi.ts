...
export interface IYokaiFactoryAbiInterface extends utils.Interface {
  functions: {
...
export interface IYokaiFactoryAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IYokaiFactoryAbiInterface;
