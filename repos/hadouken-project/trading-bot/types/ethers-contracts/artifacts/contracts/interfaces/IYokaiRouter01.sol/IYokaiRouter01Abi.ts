...
export interface IYokaiRouter01AbiInterface extends utils.Interface {
  functions: {
...
export interface IYokaiRouter01Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IYokaiRouter01AbiInterface;
