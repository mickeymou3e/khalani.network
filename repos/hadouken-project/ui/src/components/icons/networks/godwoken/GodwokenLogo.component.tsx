...
const GodwokenLogo: React.FC<IIcon> = ({ fill = '#F4B407', sx, ...rest }) => (
  <SvgIcon
    viewBox="0 0 32 32"
    sx={{ fill, height: '32px', width: '32px', ...sx }}
    {...rest}
  >
...
const StyledGodwokenLogo = styled(GodwokenLogo)(({ theme, fill }) => ({
  '&:hover': {
    fill: lighten(fill ?? theme.palette.tertiary.main, 0.3),
  },
})) as React.FC<IIcon>

export default StyledGodwokenLogo
