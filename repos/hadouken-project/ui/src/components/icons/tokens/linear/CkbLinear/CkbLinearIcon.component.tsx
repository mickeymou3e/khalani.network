...
export const CkbLinearIcon: React.FC<IIcon> = ({
  fill = '#FFFFFF',
  style,
  sx,
  ...rest
  ...
  <SvgIcon
    ...
    {...rest}
  >
    <g clipPath="url(#clip0_24_61)">
      <g filter="url(#filter0_i_24_61)">
        <circle cx="20" cy="20" r="20" fill="url(#paint0_linear_24_61)" />
      </g>
      <mask
        id="mask0_24_61"
      ...
      <g mask="url(#mask0_24_61)">
        ...
        <path
          ...
          fill={fill}
        />
        <path d="M11 29H15.6105V19.2222H19.1789L11 11V29Z" fill={fill} />
        <path d="M29 11H24.4211V20.8095H20.8526L29 29V11Z" fill={fill} />
      </g>
    </g>
    <defs>
      <filter
      ...
      >
        ...
        <feMorphology
          ...
          operator="erode"
          in="SourceAlpha"
          result="effect1_innerShadow_24_61"
        />
        <feOffset />
        ...
        />
        <feBlend mode="normal" in2="shape" result="effect1_innerShadow_24_61" />
      </filter>
      <linearGradient
        id="paint0_linear_24_61"
        x1="20"
        y1="0"
        x2="20"
        y2="40"
