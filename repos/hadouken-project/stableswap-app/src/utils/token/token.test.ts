...
describe('Utils', () => {
  ...
  describe('sortAssetsByBusinessOrder', () => {
    it('basic test', async () => {
      expect(sortAssetsByBusinessOrder('busd', 'usdt') < 0).toBeTruthy()
      expect(sortAssetsByBusinessOrder('ckb', 'eth') < 0).toBeTruthy()
      expect(sortAssetsByBusinessOrder('eth', 'ckb') > 0).toBeTruthy()
      expect(sortAssetsByBusinessOrder('notFound', 'usdc') > 0).toBeTruthy()
      expect(sortAssetsByBusinessOrder('usdc', 'notFound') < 0).toBeTruthy()
      expect(
        sortAssetsByBusinessOrder('notFound1', 'notFound2') === 0,
      ).toBeTruthy()
    })
  })
})
