...
import { WeightedPoolNew } from '../../types/WeightedPoolFactoryNew/WeightedPoolNew'
...
export function isMetaStableDeprecated(blockNumber: i32): boolean {
  ...
  if (
    network == 'ethereum' &&
    blockNumber > 15008557 &&
    blockNumber < 16380140
  ) {
    ...
    network == 'matic' &&
    blockNumber > 35414865 &&
    blockNumber < 37921111
  ) {
...
export function setPriceRateProviders(
  ...
  let poolContract = WeightedPoolNew.bind(poolAddress)
