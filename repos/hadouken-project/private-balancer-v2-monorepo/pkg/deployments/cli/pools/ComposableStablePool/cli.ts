...
const ComposableStablePoolCli: Cli = async ({ environment, parentCli }) => {
  ...
  switch (action) {
    ...
    case 'pool getters': {
      ...
      const getterMethodsCli = createGetterMethodsCli(ComposableStablePool__factory.abi);
    ...
    case 'pool setters': {
      ...
      const setterMethodsCli = createSetterMethodsCli(ComposableStablePool__factory.abi);
