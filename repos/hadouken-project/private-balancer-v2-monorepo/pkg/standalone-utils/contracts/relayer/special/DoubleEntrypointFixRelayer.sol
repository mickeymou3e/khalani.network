...
contract DoubleEntrypointFixRelayer is IFlashLoanRecipient {
    ...
    function exitBTCStablePool() external {
        ...
        getVault().exitPool(BTC_STABLE_POOL_ID, msg.sender, payable(msg.sender), request);
    ...
    function exitSNXWeightedPool() external {
        ...
        getVault().exitPool(SNX_WEIGHTED_POOL_ID, msg.sender, payable(msg.sender), request);
