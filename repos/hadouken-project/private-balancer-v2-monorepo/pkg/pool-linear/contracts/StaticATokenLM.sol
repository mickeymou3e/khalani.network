...
import "@balancer-labs/v2-interfaces/contracts/pool-linear/ILendingPool.sol";
import "@balancer-labs/v2-interfaces/contracts/pool-linear/IAaveIncentivesController.sol";
import "@balancer-labs/v2-interfaces/contracts/pool-linear/IInitializableStaticATokenLM.sol";
import "./VersionedInitializable.sol";

import "./StaticATokenErrors.sol";

import "@balancer-labs/v2-interfaces/contracts/solidity-utils/openzeppelin/IERC20.sol";
import "@balancer-labs/v2-interfaces/contracts/pool-linear/IERC20Detailed.sol";
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/ERC20.sol";
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/SafeERC20.sol";
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/SafeMath.sol";
import "@balancer-labs/v2-interfaces/contracts/pool-linear/IStaticATokenLM.sol";
 ...
 * @author Aave
 **/
contract StaticATokenLM is VersionedInitializable, ERC20("STATIC_ATOKEN_IMPL", "STATIC_ATOKEN_IMPL"), IStaticATokenLM {
    ...
    function _dynamicToStaticAmount(uint256 amount, uint256 tokenRate) internal pure returns (uint256) {
        return amount.rayDiv(tokenRate);
    }

    function _staticToDynamicAmount(uint256 amount, uint256 tokenRate) internal pure returns (uint256) {
        return amount.rayMul(tokenRate);
    }
