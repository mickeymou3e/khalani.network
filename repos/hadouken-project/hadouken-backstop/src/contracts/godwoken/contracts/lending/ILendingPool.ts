...
export interface ChangeBProtocolEventObject {
  asset: string;
  bProtocol: string;
}
export type ChangeBProtocolEvent = TypedEvent<
  [string, string],
  ChangeBProtocolEventObject
>;

export type ChangeBProtocolEventFilter = TypedEventFilter<ChangeBProtocolEvent>;
...
export interface ILendingPool extends BaseContract {
  ...
  functions: {
    ...
    setBProtocol(
      asset: PromiseOrValue<string>,
      bProtocol: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ChangeBProtocol(address,address)"(
      ...
      bProtocol?: PromiseOrValue<string> | null
    ): ChangeBProtocolEventFilter;
    ChangeBProtocol(
      asset?: PromiseOrValue<string> | null,
      bProtocol?: PromiseOrValue<string> | null
    ): ChangeBProtocolEventFilter;
