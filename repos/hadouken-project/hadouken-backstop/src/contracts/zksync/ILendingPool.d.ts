...
interface ILendingPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getBProtocol(address)": FunctionFragment;
    ...
    "setBProtocol(address,address)": FunctionFragment;
  ...
  events: {
    ...
    "ChangeBProtocol(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ChangeBProtocol"): EventFragment;
...
export type ChangeBProtocolEvent = TypedEvent<
  [string, string] & { asset: string; bProtocol: string }
>;
...
export class ILendingPool extends BaseContract {
  ...
  functions: {
    ...
    getBProtocol(asset: string, overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "ChangeBProtocol(address,address)"(
      asset?: string | null,
      bProtocol?: string | null
    ): TypedEventFilter<[string, string], { asset: string; bProtocol: string }>;
  ...
  estimateGas: {
    ...
    getBProtocol(asset: string, overrides?: CallOverrides): Promise<BigNumber>;
