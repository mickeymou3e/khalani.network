...
export type SubgraphPoolShareFragment = {
  __typename?: 'PoolShare';
  id: string;
  balance: string;
  userAddress: { __typename?: 'User'; id: string };
...
export type SubgraphSubPoolTokenFragment = {
  __typename?: 'PoolToken';
  address: string;
  balance: string;
  weight?: string | null;
...
export type TokenAttrsFragment = {
  __typename?: 'Token';
  address: string;
  symbol?: string | null;
  decimals: number;
...
export type SubgraphSubPoolFragment = {
  __typename?: 'Pool';
  id: string;
  totalShares: string;
  address: string;
...
export type SubgraphPriceRateProviderFragment = {
  __typename?: 'PriceRateProvider';
  address: string;
  token: { __typename?: 'PoolToken'; address: string };
};
...
export type PoolHistoricalLiquiditiesQuery = {
  __typename?: 'Query';
...
export type SubgraphPoolSnapshotFragment = {
  __typename?: 'PoolSnapshot';
  id: string;
  totalShares: string;
  swapVolume: string;
...
export type SubgraphJoinExitFragment = {
  __typename?: 'JoinExit';
  amounts: Array<string>;
  id: string;
  sender: string;
...
export type SubgraphBalancerFragment = {
  __typename?: 'Balancer';
  id: string;
  totalLiquidity: string;
  totalSwapVolume: string;
...
export type SubgraphTokenPriceFragment = {
  __typename?: 'TokenPrice';
  id: string;
  asset: string;
  amount: string;
...
export type TokenLatestPriceQuery = {
  __typename?: 'Query';
  latestPrice?: {
    __typename?: 'LatestPrice';
    id: string;
...
export type SubgraphUserFragment = {
  __typename?: 'User';
  id: string;
  sharesOwned?: Array<{
    __typename?: 'PoolShare';
...
export function getSdk(
  ...
  return {
    PoolShare(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PoolShareQuery>(PoolShareDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'PoolShare',
    ...
    PoolHistoricalLiquidities(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PoolHistoricalLiquiditiesQuery>(
            PoolHistoricalLiquiditiesDocument,
            variables,
    ...
    JoinExits(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<JoinExitsQuery>(JoinExitsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'JoinExits',
    ...
    Balancers(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancersQuery>(BalancersDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Balancers',
    ...
    TokenPrices(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TokenPricesQuery>(TokenPricesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'TokenPrices',
    ...
    TokenLatestPrices(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TokenLatestPricesQuery>(
    ...
    TokenLatestPrice(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TokenLatestPriceQuery>(
            TokenLatestPriceDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'TokenLatestPrice',
