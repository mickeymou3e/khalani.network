import { TokenPriceService } from '@hadouken-project/sor';
...
export class CoingeckoTokenPriceService implements TokenPriceService {
  ...
  async getTokenPriceInNativeAsset(tokenAddress: string): Promise<string> {
    const endpoint = `https://pro-api.coingecko.com/api/v3/simple/token_price/${this.platformId}?contract_addresses=${tokenAddress}&vs_currencies=${this.nativeAssetId}`;
