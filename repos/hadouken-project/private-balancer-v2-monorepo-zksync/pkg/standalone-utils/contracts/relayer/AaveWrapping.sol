...
abstract contract AaveWrapping is IBaseRelayerLibrary {
    ...
    function wrapAaveDynamicToken(
        ...
        uint256 before = staticToken.balanceOf(recipient);
        ...
        return staticToken.balanceOf(recipient) - before;
    }
    ...
    function refundTokens(address[] memory tokens, address recipient) external payable {
