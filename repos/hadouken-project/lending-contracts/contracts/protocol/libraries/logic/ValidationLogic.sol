...
library ValidationLogic {
   ...
   * @param totalDepositBalance The total amount of deposits
   * @param depositCap The deposit cap for asset
   */
  function validateDeposit(DataTypes.ReserveData storage reserve, uint256 amount, uint256 totalDepositBalance, uint256 depositCap) external view {
    ...
    if (depositCap !=  0) {
      require(depositCap >= totalDepositBalance.add(amount), Errors.DEPOSIT_CAP_REACHED);
    }
  }
