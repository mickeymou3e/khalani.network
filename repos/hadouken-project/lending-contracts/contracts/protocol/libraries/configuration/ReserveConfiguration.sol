...
library ReserveConfiguration {
  ...
  uint256 internal constant DEPOSIT_CAP_MASK =  0xFFFFFFFFFFFFFFFFFFFFFFFFFF000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFF; // prettier-ignore
  ...
  uint256 internal constant DEPOSIT_CAP_START_BIT_POSITION = 116;
    ...
    returns (uint256)
  {
    ...
    /**
   * @notice Sets the deposit cap of the reserve
   * @param self The reserve configuration
  ...
  function setDepositCap(DataTypes.ReserveConfigurationMap memory self, uint256 depositCap)
    ...
    pure
  {
    require(depositCap <= MAX_VALID_DEPOSIT_CAP, Errors.INVALID_DEPOSIT_CAP);
